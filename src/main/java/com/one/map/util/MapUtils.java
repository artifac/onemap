...
public class MapUtils {
   ...
   */
  public static int[] calculateMapScaleCenter(int mapHeight, int mapWidth, int topCoverHeight,
      int bottomCoverHeight) {
  ...
  public static final LatLng getSymmetry(LatLng latLng, LatLng center) {
    return new LatLng(2.0D * center.latitude - latLng.latitude,
        2.0D * center.longitude - latLng.longitude);
  }
